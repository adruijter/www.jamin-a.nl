...
DROP PROCEDURE IF EXISTS spGetAllMagazijnProductLimitOffCountOver;

-- Verander even tijdelijk de opdrachtprompt naar //
DELIMITER //

CREATE PROCEDURE spGetAllMagazijnProductLimitOffsetCountOver
(
...
CALL spGetAllMagazijnProductLimitOffsetCountOver();
